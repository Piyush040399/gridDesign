...
function createCard(name, brand, price, isAccessory, preview) {
  ...
  imageCard.src = preview;
  productCard.appendChild(imageCard);
  let detailsDiv = document.createElement("div");
  detailsDiv.className = "details-div";
  let headDetails = document.createElement("h3");
  headDetails.className = "heading";
  headDetails.innerText = name;
  let brandDetails = document.createElement("h4");
  brandDetails.className = "brand";
  brandDetails.innerText = brand;
  let priceDetail = document.createElement("h5");
  priceDetail.className = "price";
  priceDetail.innerText = "Rs " + price;
  detailsDiv.append(headDetails, brandDetails, priceDetail);
  productCard.appendChild(detailsDiv);

/*------- condition for product section ------ */

  if (isAccessory == true) {
    let accesoriesCard = document.getElementById("accesoriesSection");
    accesoriesCard.appendChild(productCard);
  } else {
    let clothingCard = document.getElementById("clothingSection");
    clothingCard.appendChild(productCard);
  }
}
...
/* looping all products to render */
